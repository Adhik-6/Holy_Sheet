...
export const InputArea = ({ handleSend, input, setInput, disabled }: InputAreaProps) => {
    ...
    return (
        <div className="absolute bottom-0 left-0 right-0 p-4 md:px-8 md:pb-6 z-30 pointer-events-none">
            ...
            <div className="relative flex flex-col gap-2 bg-card/60 backdrop-blur-md border border-border rounded-2xl p-2 shadow-2xl">
              ...
              {selectedFile && (
                  <div className="flex flex-wrap gap-2 mx-2 mt-2">
                      <div className="inline-flex items-center gap-3 p-2 pr-3 bg-white/5 border border-white/10 rounded-xl relative group/file animate-in fade-in slide-in-from-bottom-2 duration-200">
                          ...
                          <button 
                            ...
                            className="ml-2 p-1 hover:bg-red-500/20 hover:text-red-400 text-muted-foreground rounded-md transition-colors"
                          >
                              <X size={14} />
                          </button>
                      </div>
              ...
              <div className="flex items-end gap-2">
                ...
                <textarea 
                    ...
                    rows={1}
                    className="flex-1 min-h-10 max-h-50 w-full bg-transparent border-0 focus:ring-0 resize-none text-[15px] font-medium placeholder:text-muted-foreground py-2.5 custom-scrollbar focus-visible:outline-none"
                    placeholder="Ask ExcelGPT to analyze data..."
                    disabled={disabled}
                />
                
                <div className="flex items-center gap-1 shrink-0 mb-0.5">
                    <Button variant="ghost" size="icon" className="text-muted-foreground hover:bg-muted/20 rounded-xl">
                    <Mic size={20} />
                    </Button>
