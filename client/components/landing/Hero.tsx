  ...
  return (
    <section className="relative pt-24 pb-20 px-6 overflow-hidden">
      ...
      <div className="container mx-auto max-w-5xl text-center">
        ...
        >
          <Badge className="gap-2 bg-primary/10 border border-primary/20 text-primary text-[10px] font-black uppercase tracking-widest rounded-full px-4 py-1.5">
        ...
        >
          The private AI Data Analyst built for security-first organizations.
          Zero server egress. Infinite local compute.
        </motion.p>
        ...
        >
          ...
          <motion.div
            whileHover={{
              scale: 1.05,
              boxShadow:
                "0 0 30px -5px color-mix(in srgb, var(--primary), transparent 60%)",
            }}
            whileTap={{ scale: 0.95 }}
          ...
          >
            <Button
              asChild
              size="lg"
              className="w-full sm:w-auto rounded-2xl font-bold py-6 px-10 gap-2 shadow-xl shadow-primary/10"
            >
              <Link href="/chat">
          ...
          >
            <Button
              ...
              size="lg"
              variant="outline"
              className="w-full sm:w-auto rounded-2xl font-bold py-6 px-10 gap-2 backdrop-blur-sm"
            >
              <Link href="#features">
                <Code size={20} />
                View Documentation
        ...
        >
          <Card className="relative max-w-5xl mx-auto rounded-[2.5rem] p-3 glass-card shadow-2xl overflow-hidden group border border-border">
                ...
                <div className="w-20 sm:w-64 border-r border-border bg-muted/30 hidden sm:flex flex-col p-6 text-left">
                  ...
                  <div className="space-y-4">
                    {[1, 2, 3].map((i) => (
                      <div
                        key={i}
                        className="h-2 w-full bg-foreground/5 rounded-full"
                      />
                    ))}
                  </div>
                </div>
