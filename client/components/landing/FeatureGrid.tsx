      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-20">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto text-lg">
            Security shouldn't compromise intelligence. We brought the lab to your
            browser.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((f, idx) => (
            <motion.div
              ...
              className="h-full"
            >
              <Card className="group h-full p-8 rounded-3xl glass-card glow-primary hover:bg-white/3">
