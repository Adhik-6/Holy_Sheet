...
import { BarChart, Users, Microscope, Shield } from "lucide-react";
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-20">
          <h2 className="text-4xl md:text-5xl font-black mb-6 tracking-tight">
            Built for Secure Verticals
          </h2>
          <p className="text-muted-foreground text-lg">
            Trusted by professionals who can't afford a data breach.
          </p>
        </div>
          ...
          {personas.map((p, i) => {
            ...
            return (
              ...
              >
                <Card
                  className={[
                    "h-full p-10 rounded-[2.5rem] border border-border glass-card text-center cursor-default group transition-all duration-300",
                    isPrimary ? "glow-primary" : "glow-accent",
                  ].join(" ")}
                >
                  <div
                    className={[
                      "w-20 h-20 rounded-3xl flex items-center justify-center mx-auto mb-8 transition-all duration-300",
                      isPrimary
